...
function drawCube(gl, program) {
  // 24 vertices for the 6 faces, with color set to white (1, 1, 1, 1)
  var vertices = new Float32Array([
    // Front face (normal: 0, 0, 1)
    -0.5, -0.5,  0.5,   1, 1, 1, 1,    0, 0, 1,
     0.5, -0.5,  0.5,   1, 1, 1, 1,    0, 0, 1,
     0.5,  0.5,  0.5,   1, 1, 1, 1,    0, 0, 1,
    -0.5,  0.5,  0.5,   1, 1, 1, 1,    0, 0, 1,
